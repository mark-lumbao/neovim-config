...
" let s:t_Co = exists('&t_Co') && !has('gui_running') ? (&t_Co ?? 0) : -1 --> original code
let s:t_Co = &t_Co " syntax I borrowed from neovim default colorschemes
...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    ...
    " Also borrowed the block below from neovim default colorschemes
