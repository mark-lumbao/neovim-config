" Name:         Dark Retro Box
" Description:  Retro groove color scheme similar to gruvbox dark option originally designed by morhetz <morhetz@gmail.com>
" Author:       Em Lumbao markanthonylumbao@gmail.com, ported from retrobox of Maxim Kim <habamax@gmail.com>
" Maintainer:   Em Lumbao
" License:      Vim License (see `:help license`)
" Last Updated: Tue 19 Mar 2023
"
" NOTE:
" Borrowed from Vim's retrobox.
" Only copied options for dark termguicolors.

hi clear
set bg=dark

let g:colors_name = 'dark_retrobox'
